package tree.movie.manager;

import java.io.FileNotFoundException;
import java.text.ParseException;

import tree.dsa.list.List;
import tree.movie.data.Movie;
import tree.movie.data.WatchRecord;
...
public class TreeManager {
	 ...
	 */
	public TreeManager(String pathToMovieFile, String pathToWatchFile) throws FileNotFoundException, ParseException {
