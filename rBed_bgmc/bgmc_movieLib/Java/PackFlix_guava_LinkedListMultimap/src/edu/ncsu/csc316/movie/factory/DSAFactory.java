...
//	}
	...
	public static <K extends Comparable<K>, V> LinkedListMultimap<K, V> getMap() {
		return getLinkedListMultimap();
	}
...
//	 */
//	private static <K extends Comparable<K>, V> ArrayListMultimap<K, V> getArrayListMultimap() {
...
//	private static <K extends Comparable<K>, V> HashBiMap<K, V> getHashBiMap() {
//		return HashBiMap.create();
//	}
	
	private static <K extends Comparable<K>, V> LinkedListMultimap<K, V> getLinkedListMultimap() {
